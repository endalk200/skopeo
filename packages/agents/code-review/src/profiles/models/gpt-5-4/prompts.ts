...
/**
 * GPT-5.4 prompt tuning notes (OpenAI GPT-5.x prompting guidance):
 *
 * GPT-5.4 is the previous lower-cost/latency tier of the GPT-5.x line and
 * follows the same published prompting guidance as GPT-5.5. These prompts
 * currently match the GPT-5.5 ones by design, but are kept self-contained so
 ...
 * - GPT-5.4 follows instructions literally; contradictory instructions burn
...
/**
 * Builds the GPT-5.4 system prompt for the given Review Depth.
 */
const createGpt54SystemPrompt = (
	depth: ReviewDepth,
...
/**
 * Builds the GPT-5.4 user prompt for the given Review Depth.
 */
...
export { createGpt54SystemPrompt, createGpt54UserPrompt };
