...
- **Don't ship the TUI shell into production.** The shell is optimised for being driven by hand from a terminal. The validated design behind it is the bit worth keeping.
- **Don't promote prototype logic directly.** Reimplement the validated design with production error handling, conventions, and tests.
